...
gem 'roo-xls', :git => 'git@github.com:roo-rb/roo-xls', :ref => '0a5ef88'
gem 'streamio-ffmpeg'
gem 'rake', '< 11.0'
gem 'timeliness'
...
group :development do
  ...
  gem 'traceroute', git: 'git@github.com:distributedlife/traceroute', :ref => '94eb4e66e13c590e07d3b76cc154d2e32d5c5c21'
  gem 'rubocop'
end
